 ...
 * 	 This interface provides the checkIsPlaceable method to any classes that implement it
 * 
 */
...
{
	//abstract method that is used for checking if a certain square is empty and returns a boolean
	abstract boolean checkIsPlaceable(Shape tempShape);
}
