...
{	
	...
	{	
		//Surround the entire main method with a try-block
		try
		{
			//Create a new GameView object by passing a new GameModel object
			new GameView(new GameModel());			
		}
		//Catch any exceptions thrown by the main method and print out a message
		catch(Exception e)
		{
